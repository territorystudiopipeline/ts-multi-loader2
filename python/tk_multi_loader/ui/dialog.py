...
"")
        ...
        # sort label
        self.sort_label = QtGui.QLabel(Dialog)
        self.sort_label.setObjectName("sort_label")
        self.horizontalLayout_4.addWidget(self.sort_label)
        # sort combobox
        self.sort_by = QtGui.QComboBox(Dialog)
        self.sort_by.setMinimumSize(QtCore.QSize(160, 26))
        self.sort_by.setObjectName("sort_by")
        self.sort_by.addItem("Date (Latest First)")
        self.sort_by.addItem("Date (Oldest First)")
        self.sort_by.addItem("Name (A \u2192 Z)")
        self.sort_by.addItem("Name (Z \u2192 A)")
        self.sort_by.addItem("Version (Highest First)")
        self.sort_by.addItem("Version (Lowest First)")
        self.horizontalLayout_4.addWidget(self.sort_by)
        spacerItem1 = QtGui.QSpacerItem(12, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
